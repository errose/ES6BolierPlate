...
var Accordion = (function () {
  ...
  accordion.init = function () {
    $(document)
      .on('click', '[data-accordion-trigger]', function(e){
        e.preventDefault();
        var target = $(this).attr('href'),
            siblings = $(target).siblings();
        Openable.toggle(siblings, false, false);
...
var Header = (function () {
  ...
  header.init = function () {
    ...
    NavItems.init();
    NavDropdown.init();
    if($('.PageNav').hasClass('is-stickable')){
      Stickable.stick('.PageNav.is-stickable');
    }
    if($('.Header-toggle').length){
      Stickable.stick('.Header-toggle', -65);
    }
  };
...
var $ = __webpack_require__(0);
var Openable = __webpack_require__(1);
...
var Waypoint = __webpack_require__(2);
Waypoint.Sticky = __webpack_require__(3);
