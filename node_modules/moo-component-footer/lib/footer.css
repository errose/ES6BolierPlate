...
:root {
  --Footer-bg-color: var(--color-gray-lightest);
  --Footer-border-color: var(--color-line);
  --Footer-fixed-border-color: #e9e9e9;
  --Footer-disclaimer-color: #959595;
}
...
.Footer--fixed {
  ...
  border-top: 1px solid var(--Footer-fixed-border-color);
}
...
.Footer-disclaimer p,
.Footer-copyright {
  font-family: var(--font-family-sans-serif-400);
  font-weight: 400;
  font-size: 1.3rem;
  line-height: 1.9rem;
